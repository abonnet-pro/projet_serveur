...
module.exports = (userAccountService, clientService, publicationService, abonnementService, paiementService, communicationService) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await clientService.dao.db.query("CREATE TABLE client(id SERIAL PRIMARY KEY, nom TEXT NOT NULL, prenom TEXT NOT NULL, displayName TEXT NOT NULL, login TEXT NOT NULL, dateCreation DATE NOT NULL, telephone TEXT NOT NULL, dateNaissance DATE NOT NULL, lieuNaissance TEXT NOT NULL, rue TEXT NOT NULL, cp TEXT NOT NULL, ville TEXT NOT NULL, challenge TEXT NOT NULL, role TEXT NOT NULL, active BOOLEAN NOT NULL)")
            ...
            for(let i = 0; i < 50; i++) {
                await clientService.dao.insert(new Client("Client " + i, "Client", "Client", "client" + i + "@client.fr", "0612345678","14/01/1993", "Saint-Etienne", "2 rue rascas", "84000", "Avignon", userAccountService.hashPassword("client"), "CLIENT", true))
            }
