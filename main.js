...
require('./api/client')(app, clientService, abonnementService, paiementService, publicationService, role, dirName, jwt)
require('./api/abonnement')(app, abonnementService, publicationService, clientService, paiementService, role, dirName, jwt)
require('./api/paiement')(app, paiementService, abonnementService, role, dirName, jwt)
